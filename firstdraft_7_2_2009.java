...
import java.util.*;
import javax.swing.*;
public class firstdraft_7_2_2009 {
	...
	public static void main(String[] args) {
		...
		while(userPlay) {
			// Function app
			firstdraft_7_2_2009 app=new firstdraft_7_2_2009();
			// Setup grids
			...
			while(bombRep) {
				...
				if(show_grid[0][0].equals("found")) {
					...
					String playAgain=JOptionPane.showInputDialog(popupGridWin, "");
					// No play again
				...
				// Play Game
					...
					app.game_play(hid_grid,show_grid);
					gameScore+=5;
				}
			}
		}
	...
	// Game Play
	public void game_play(int hid_grid[][],String show_grid[][]) {
